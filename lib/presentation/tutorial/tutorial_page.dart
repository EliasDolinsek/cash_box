          ...
          Expanded(
            ...
            child: Align(
              ...
              child: Padding(
                ...
                child: Text(
                    AppLocalizations.translateOf(context, "txt_swipe_right")),
              ),
            ),
          ),
        ],
...
class _ReceiptsTutorialWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _ComponentTutorialMobilePortrait(
        ...
        Expanded(
          ...
          child: Center(
            child: OutlineButton(
              ...
              child: Text(AppLocalizations.translateOf(context, "btn_close_tutorial")),
            ),
          ),
        )
      ],
